...
class MyHttpRequestHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        if (self.path == "/style.css" or self.path == "/print.css" or self.path == "/logo.png"  or self.path == "/favicon.ico"):
            ...
            if 'calendar' in query_components:
                calendar = query_components["calendar"][0]
...
def assembleHtmlResponse(year,calendar):
    ...
    for day in range (1,32):
        html = html + "<tr>\n"
        html = html + "<td> <div class=\"daynr\">" + str(day) + "</div> </td>\n"
        for month in range(1,13):
            ...
            try:
                ...
                pass
                # print ("no such day! :)" + str(month) + "-" + str(day))
            if isweekend:
